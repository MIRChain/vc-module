...
func DeployAbstractClaimsVerifier(auth *bind.TransactOpts[gost3410.PublicKey], backend bind.ContractBackend[gost3410.PublicKey], name string, version string, chainId *big.Int, verifyingContract common.Address, _registryAddress common.Address) (common.Address, *types.Transaction[gost3410.PublicKey], *AbstractClaimsVerifier, error) {
	parsed, err := abi.JSON[gost3410.PublicKey](strings.NewReader(AbstractClaimsVerifierABI))
	if err != nil {
...
func NewAbstractClaimsVerifier(address common.Address, backend bind.ContractBackend[gost3410.PublicKey]) (*AbstractClaimsVerifier, error) {
...
func NewAbstractClaimsVerifierTransactor(address common.Address, transactor bind.ContractTransactor[gost3410.PublicKey]) (*AbstractClaimsVerifierTransactor, error) {
...
func bindAbstractClaimsVerifier(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor[gost3410.PublicKey], filterer bind.ContractFilterer) (*bind.BoundContract[gost3410.PublicKey], error) {
	parsed, err := abi.JSON[gost3410.PublicKey](strings.NewReader(AbstractClaimsVerifierABI))
	if err != nil {
		return nil, err
	}
...
func (_AbstractClaimsVerifier *AbstractClaimsVerifierRaw) Transfer(opts *bind.TransactOpts[gost3410.PublicKey]) (*types.Transaction[gost3410.PublicKey], error) {
	return _AbstractClaimsVerifier.Contract.AbstractClaimsVerifierTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_AbstractClaimsVerifier *AbstractClaimsVerifierRaw) Transact(opts *bind.TransactOpts[gost3410.PublicKey], method string, params ...interface{}) (*types.Transaction[gost3410.PublicKey], error) {
...
// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_AbstractClaimsVerifier *AbstractClaimsVerifierTransactorRaw) Transfer(opts *bind.TransactOpts[gost3410.PublicKey]) (*types.Transaction[gost3410.PublicKey], error) {
	return _AbstractClaimsVerifier.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_AbstractClaimsVerifier *AbstractClaimsVerifierTransactorRaw) Transact(opts *bind.TransactOpts[gost3410.PublicKey], method string, params ...interface{}) (*types.Transaction[gost3410.PublicKey], error) {
